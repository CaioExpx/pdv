...
import { LayoutDashboard, ShoppingCart, Package, BookOpen, FileText, LogOut } from 'lucide-react'
    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-50 md:hidden safe-area-bottom">
      <div className="flex items-stretch h-16">
        ...
        <button
          ...
          className="flex-1 flex flex-col items-center justify-center gap-1 text-[10px] font-medium text-slate-400 transition-colors hover:text-red-500"
        >
          <div className="p-1.5">
